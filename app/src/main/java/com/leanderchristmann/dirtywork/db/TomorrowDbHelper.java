...
public class TomorrowDbHelper extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "tomorrow.db";

    private static final String TABLE_NAME = "tomorrow_todos";
    private static final String COLUMN_ID = "id";
    private static final String COLUMN_TEXT = "todoText";
    private static final String COLUMN_STATUS = "status";
    private static final String CREATE_TOMORROW_TABLE = "CREATE TABLE " + TABLE_NAME
            + "(" + COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
            COLUMN_TEXT + " TEXT, " + COLUMN_STATUS + " INTEGER);";

    SQLiteDatabase db;

    public TomorrowDbHelper(Context context) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(CREATE_TOMORROW_TABLE);
    }
